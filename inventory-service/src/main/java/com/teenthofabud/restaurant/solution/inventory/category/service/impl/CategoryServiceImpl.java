package com.teenthofabud.restaurant.solution.inventory.category.service.impl;
...
import com.teenthofabud.restaurant.solution.inventory.category.converter.CategoryDto2EntityConverter;
import com.teenthofabud.restaurant.solution.inventory.category.converter.CategoryForm2EntityConverter;
import com.teenthofabud.restaurant.solution.inventory.category.data.*;
import com.teenthofabud.restaurant.solution.inventory.category.mapper.CategoryEntitySelfMapper;
import com.teenthofabud.restaurant.solution.inventory.category.mapper.CategoryForm2EntityMapper;
...
import com.teenthofabud.restaurant.solution.inventory.category.validator.CategoryDtoValidator;
import com.teenthofabud.restaurant.solution.inventory.category.validator.CategoryFormRelaxedValidator;
import com.teenthofabud.restaurant.solution.inventory.category.validator.CategoryFormValidator;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public Set<CategoryVo> retrieveAllByNaturalOrdering() {
        ...
        List<CategoryVo> categoryVoList = inventoryServiceHelper.categoryEntity2DetailedVo(categoryEntityList);
    ...
    public CategoryVo retrieveDetailsById(String id, Optional<TOABCascadeLevel> optionalCascadeLevel) throws CategoryException {
        ...
        if(!optEntity.isPresent()) {
            ...
            throw new CategoryException(InventoryErrorCode.INVENTORY_NOT_FOUND, new Object[] { "id", String.valueOf(id) });
        }
        ...
        CategoryVo vo = inventoryServiceHelper.categoryEntity2DetailedVo(entity);
    ...
    public List<CategoryVo> retrieveAllMatchingDetailsByCriteria(
        ...
        matchedCategoryList = inventoryServiceHelper.categoryEntity2DetailedVo(categoryEntityList);
    ...
    public String createCategory(CategoryForm form) throws CategoryException {
        ...
        if(repository.existsByName(expectedEntity.getName())) {
            ...
            throw new CategoryException(InventoryErrorCode.INVENTORY_EXISTS,
        ...
        if(actualEntity == null) {
            ...
            throw new CategoryException(InventoryErrorCode.INVENTORY_ACTION_FAILURE,
    ...
    public void updateCategory(String id, CategoryForm form) throws CategoryException {
        ...
        if(!actualEntity.getActive()) {
            ...
            throw new CategoryException(InventoryErrorCode.INVENTORY_INACTIVE, new Object[] { String.valueOf(id) });
        }
        log.debug("CategoryEntity is active with id: {}", id);

        if(form == null) {
            log.debug("CategoryForm is null");
            throw new CategoryException(InventoryErrorCode.INVENTORY_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        log.debug("Form details : {}", form);
        ...
        if(err.hasErrors()) {
            ...
            throw new CategoryException(InventoryErrorCode.INVENTORY_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are empty" });
        }
        log.debug("All attributes of CategoryForm are valid");
        ...
        if(!optExpectedEntity.isPresent()) {
            ...
            throw new CategoryException(InventoryErrorCode.INVENTORY_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are expected with new values" });
        }
    ...
    public void applyPatchOnCategory(String id, List<PatchOperationForm> patches) throws CategoryException {
        ...
        if(patches == null || (patches != null && patches.isEmpty())) {
            ...
            throw new CategoryException(InventoryErrorCode.INVENTORY_ATTRIBUTE_UNEXPECTED, new Object[]{ "patch", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        ...
        try {
            ...
            if(e.getMessage().contains("no such path in target")) {
                ...
                ex = new CategoryException(InventoryErrorCode.INVENTORY_ATTRIBUTE_INVALID, new Object[]{ "path" });
            } else {
                ex = new CategoryException(InventoryErrorCode.INVENTORY_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
            }
            throw ex;
        } catch (IOException e) {
            log.debug("Failed to patch list items to CategoryDto: {}", e);
            throw new CategoryException(InventoryErrorCode.INVENTORY_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
        }
