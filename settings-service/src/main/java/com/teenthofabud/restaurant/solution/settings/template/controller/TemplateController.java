package com.teenthofabud.restaurant.solution.settings.template.controller;
...
import com.teenthofabud.restaurant.solution.settings.template.data.TemplateMessageTemplate;
...
public class TemplateController {
    ...
    public List<TemplateVo> getAllTemplatesByFilters(@RequestParam(required = false) String name, 
        ...
        throw new TemplateException(SettingsErrorCode.SETTINGS_ATTRIBUTE_INVALID, new Object[] { "filters" });
    }
    ...
    @io.swagger.v3.oas.annotations.Parameter(in = ParameterIn.QUERY, description = "levels of nested fields to be unfolded within the response body")
        ...
        if(StringUtils.hasText(StringUtils.trimWhitespace(id)) && StringUtils.isEmpty(StringUtils.trimWhitespace(cascadeUntilLevel))) {
            ...
            try {
                ...
                throw new TemplateException(SettingsErrorCode.SETTINGS_ATTRIBUTE_INVALID, new Object[] { "cascadeUntilLevel", cascadeUntilLevel });
            }
        }
        log.debug(TemplateMessageTemplate.MSG_TEMPLATE_TEMPLATE_ID_EMPTY.getValue());
        throw new TemplateException(SettingsErrorCode.SETTINGS_ATTRIBUTE_INVALID, new Object[] { "id", id });
