...
@Component
@Slf4j
public class TemplateDto2EntityConverter implements ComparativePatchConverter<TemplateDto, TemplateEntity> {
    ...
    @Override
    public void compareAndMap(TemplateDto dto, TemplateEntity actualEntity) throws TOABBaseException {
