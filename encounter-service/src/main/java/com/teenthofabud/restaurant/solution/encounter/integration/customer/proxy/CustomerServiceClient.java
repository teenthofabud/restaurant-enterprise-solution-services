...
@FeignClient(value = CustomerServiceClient.SERVICE_CLIENT_NAME, url = "${res.encounter.customer.service.url}",
        configuration = CustomerServiceIntegrationConfiguration.class)
