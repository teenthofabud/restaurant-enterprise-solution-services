package com.teenthofabud.restaurant.solution.booking.engagement.service.impl;
...
import com.teenthofabud.restaurant.solution.booking.engagement.converter.EngagementDto2DocumentConverter;
import com.teenthofabud.restaurant.solution.booking.engagement.converter.EngagementForm2DocumentConverter;
import com.teenthofabud.restaurant.solution.booking.engagement.data.*;
import com.teenthofabud.restaurant.solution.booking.engagement.mapper.EngagementDocumentSelfMapper;
import com.teenthofabud.restaurant.solution.booking.engagement.mapper.EngagementForm2DocumentMapper;
import com.teenthofabud.restaurant.solution.booking.engagement.repository.EngagementRepository;
import com.teenthofabud.restaurant.solution.booking.engagement.service.EngagementService;
import com.teenthofabud.restaurant.solution.booking.engagement.validator.EngagementDtoValidator;
import com.teenthofabud.restaurant.solution.booking.engagement.validator.EngagementFormRelaxedValidator;
import com.teenthofabud.restaurant.solution.booking.engagement.validator.EngagementFormValidator;
...
public class EngagementServiceImpl implements EngagementService {
    ...
    private Long parseEngagementId(String id) throws EngagementException {
        ...
        try {
            ...
            throw new EngagementException(BookingErrorCode.BOOKING_ATTRIBUTE_INVALID, new Object[] { "id", id });
        }
        return engagementId;
    }
    ...
    public Set<EngagementVo> retrieveAllByNaturalOrdering() {
        ...
        List<EngagementVo> engagementVoList = bookingServiceHelper.engagementDocument2DetailedVo(engagementDocumentList);
    ...
    public EngagementVo retrieveDetailsById(String id, Optional<TOABCascadeLevel> optionalCascadeLevel) throws EngagementException {
        ...
        if(optDocument.isEmpty()) {
            ...
            throw new EngagementException(BookingErrorCode.BOOKING_NOT_FOUND, new Object[] { "id", String.valueOf(id) });
        }
        ...
        EngagementVo vo = bookingServiceHelper.engagementDocument2DetailedVo(document);
    ...
    public List<EngagementVo> retrieveAllMatchingDetailsByAssociationId(String associationId, Optional<TOABCascadeLevel> optionalCascadeLevel) throws EngagementException {
        ...
        try {
            ...
            if(!associationVo.getActive()) {
                throw new AssociationException(BookingErrorCode.BOOKING_INACTIVE, new Object [] { associationId });
            }
        } catch (AssociationException e) {
            log.error("associationId is invalid", e);
            throw new EngagementException(BookingErrorCode.BOOKING_ATTRIBUTE_INVALID, new Object [] { "associationId: " + associationId });
        }
        List<EngagementDocument> engagementDocumentList = repository.findByAssociationId(associationId);
        TOABCascadeLevel cascadeLevel = optionalCascadeLevel.isPresent() ? optionalCascadeLevel.get() : TOABCascadeLevel.ZERO;
        TOABRequestContextHolder.setCascadeLevelContext(cascadeLevel);
        List<EngagementVo> matchedEngagementList = bookingServiceHelper.engagementDocument2DetailedVo(engagementDocumentList);
        ...
        if(matchedEngagementList.isEmpty()) {
            ...
            throw new EngagementException(BookingErrorCode.BOOKING_NOT_FOUND, new Object[] { "associationId", associationId });
        }
    ...
    public List<EngagementVo> retrieveAllMatchingDetailsByCriteria(Optional<String> optionalAssociationId, Optional<String> optionalEvent, Optional<String> optionalTimestamp) throws EngagementException {
        ...
        if(StringUtils.hasText(StringUtils.trimWhitespace(timestamp))) {
            try {
                ...
                throw new EngagementException(BookingErrorCode.BOOKING_ATTRIBUTE_INVALID, new Object[] { "timestamp", timestamp });
            } 
            log.debug("event {} is valid", event);
            providedFilters.put("event", event);
            document.setEvent(EngagementEvent.valueOf(event));
        ...
        matchedEngagementList = bookingServiceHelper.engagementDocument2DetailedVo(engagementDocumentList);
    ...
    public String createEngagement(EngagementForm form) throws EngagementException {
        ...
        if(form == null) {
            ...
            throw new EngagementException(BookingErrorCode.BOOKING_ATTRIBUTE_UNEXPECTED,
        ...
        if(repository.existsByAssociationIdAndEventAndDateAndTime(
            ...
            log.debug(EngagementMessageTemplate.MSG_TEMPLATE_ENGAGEMENT_EXISTS_BY_ASSOCIATION_ID_EVENT_DATE_TIME.getValue(),
                    expectedDocument.getAssociationId(), expectedDocument.getEvent(), expectedDocument.getDate(), expectedDocument.getTime());
            throw new EngagementException(BookingErrorCode.BOOKING_EXISTS,
        ...
        if(actualDocument == null) {
            ...
            throw new EngagementException(BookingErrorCode.BOOKING_ACTION_FAILURE,
    ...
    public void updateEngagement(String id, EngagementForm form) throws EngagementException {
        ...
        if(!actualDocument.getActive()) {
            ...
            throw new EngagementException(BookingErrorCode.BOOKING_INACTIVE, new Object[] { String.valueOf(id) });
        }
        log.debug("EngagementDocument is active with id: {}", id);

        if(form == null) {
            log.debug("EngagementForm is null");
            throw new EngagementException(BookingErrorCode.BOOKING_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        log.debug("Form details : {}", form);
        ...
        if(err.hasErrors()) {
            ...
            throw new EngagementException(BookingErrorCode.BOOKING_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are empty" });
        }
        log.debug("All attributes of EngagementForm are valid");
        ...
        if(optExpectedDocument.isEmpty()) {
            ...
            throw new EngagementException(BookingErrorCode.BOOKING_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are expected with new values" });
        }
    ...
    public void applyPatchOnEngagement(String id, List<PatchOperationForm> patches) throws EngagementException {
        ...
        if(patches == null || (patches != null && patches.isEmpty())) {
            ...
            throw new EngagementException(BookingErrorCode.BOOKING_ATTRIBUTE_UNEXPECTED, new Object[]{ "patch", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        ...
        try {
            ...
            if(e.getMessage().contains("no such path in target")) {
                ...
                ex = new EngagementException(BookingErrorCode.BOOKING_ATTRIBUTE_INVALID, new Object[]{ "path" });
            } else {
                ex = new EngagementException(BookingErrorCode.BOOKING_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
            }
            throw ex;
        } catch (IOException e) {
            log.debug("Failed to patch list items to EngagementDto: {}", e);
            throw new EngagementException(BookingErrorCode.BOOKING_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
        }
