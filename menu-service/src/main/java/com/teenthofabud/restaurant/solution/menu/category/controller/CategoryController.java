package com.teenthofabud.restaurant.solution.menu.category.controller;
...
import com.teenthofabud.restaurant.solution.menu.category.data.CategoryMessageTemplate;
...
public class CategoryController {
    ...
    public List<CategoryVo> getAllCategoriesByFilters(@RequestParam(required = false) String name, 
        ...
        throw new CategoryException(MenuErrorCode.MENU_ATTRIBUTE_INVALID, new Object[] { "filters" });
    }
    ...
    @io.swagger.v3.oas.annotations.Parameter(in = ParameterIn.QUERY, description = "levels of nested fields to be unfolded within the response body")
        ...
        if(StringUtils.hasText(StringUtils.trimWhitespace(id)) && StringUtils.isEmpty(StringUtils.trimWhitespace(cascadeUntilLevel))) {
            ...
            try {
                ...
                throw new CategoryException(MenuErrorCode.MENU_ATTRIBUTE_INVALID, new Object[] { "cascadeUntilLevel", cascadeUntilLevel });
            }
        }
        log.debug(CategoryMessageTemplate.MSG_TEMPLATE_CATEGORY_ID_EMPTY.getValue());
        throw new CategoryException(MenuErrorCode.MENU_ATTRIBUTE_INVALID, new Object[] { "id", id });
