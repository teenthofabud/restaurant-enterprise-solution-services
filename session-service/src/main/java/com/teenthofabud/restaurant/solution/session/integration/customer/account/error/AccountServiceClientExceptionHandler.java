package com.teenthofabud.restaurant.solution.session.integration.customer.account.error;
...
@Slf4j
@Component
public class AccountServiceClientExceptionHandler extends TOABFeignBaseExceptionHandler {
