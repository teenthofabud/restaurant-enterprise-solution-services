package com.teenthofabud.restaurant.solution.session.experience.service.impl;
...
import com.teenthofabud.restaurant.solution.session.experience.converter.ExperienceDto2DocumentConverter;
import com.teenthofabud.restaurant.solution.session.experience.converter.ExperienceForm2DocumentConverter;
import com.teenthofabud.restaurant.solution.session.experience.data.*;
import com.teenthofabud.restaurant.solution.session.experience.mapper.ExperienceDocumentSelfMapper;
import com.teenthofabud.restaurant.solution.session.experience.mapper.ExperienceForm2DocumentMapper;
import com.teenthofabud.restaurant.solution.session.experience.repository.ExperienceRepository;
import com.teenthofabud.restaurant.solution.session.experience.service.ExperienceService;
import com.teenthofabud.restaurant.solution.session.experience.validator.ExperienceDtoValidator;
import com.teenthofabud.restaurant.solution.session.experience.validator.ExperienceFormRelaxedValidator;
import com.teenthofabud.restaurant.solution.session.experience.validator.ExperienceFormValidator;
...
public class ExperienceServiceImpl implements ExperienceService {
    ...
    private Long parseExperienceId(String id) throws ExperienceException {
        ...
        try {
            ...
            throw new ExperienceException(SessionErrorCode.SESSION_ATTRIBUTE_INVALID, new Object[] { "id", id });
        }
        return experienceId;
    }
    ...
    public Set<ExperienceVo> retrieveAllByNaturalOrdering() {
        ...
        List<ExperienceVo> experienceVoList = sessionServiceHelper.experienceDocument2DetailedVo(experienceDocumentList);
    ...
    public ExperienceVo retrieveDetailsById(String id, Optional<TOABCascadeLevel> optionalCascadeLevel) throws ExperienceException {
        ...
        if(optDocument.isEmpty()) {
            ...
            throw new ExperienceException(SessionErrorCode.SESSION_NOT_FOUND, new Object[] { "id", String.valueOf(id) });
        }
        ...
        ExperienceVo vo = sessionServiceHelper.experienceDocument2DetailedVo(document);
    ...
    public List<ExperienceVo> retrieveAllMatchingDetailsByCriteria(
        ...
        matchedExperienceList = sessionServiceHelper.experienceDocument2DetailedVo(experienceDocumentList);
    ...
    public String createExperience(ExperienceForm form) throws ExperienceException {
        ...
        if(form == null) {
            ...
            throw new ExperienceException(SessionErrorCode.SESSION_ATTRIBUTE_UNEXPECTED,
        ...
        if(repository.existsByName(expectedDocument.getName())) {
            ...
            throw new ExperienceException(SessionErrorCode.SESSION_EXISTS,
        ...
        if(actualDocument == null) {
            ...
            throw new ExperienceException(SessionErrorCode.SESSION_ACTION_FAILURE,
    ...
    public void updateExperience(String id, ExperienceForm form) throws ExperienceException {
        ...
        if(!actualDocument.getActive()) {
            ...
            throw new ExperienceException(SessionErrorCode.SESSION_INACTIVE, new Object[] { String.valueOf(id) });
        }
        log.debug("ExperienceDocument is active with id: {}", id);

        if(form == null) {
            log.debug("ExperienceForm is null");
            throw new ExperienceException(SessionErrorCode.SESSION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        log.debug("Form details : {}", form);
        ...
        if(err.hasErrors()) {
            ...
            throw new ExperienceException(SessionErrorCode.SESSION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are empty" });
        }
        log.debug("All attributes of ExperienceForm are valid");
        ...
        if(optExpectedDocument.isEmpty()) {
            ...
            throw new ExperienceException(SessionErrorCode.SESSION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are expected with new values" });
        }
    ...
    public void applyPatchOnExperience(String id, List<PatchOperationForm> patches) throws ExperienceException {
        ...
        if(patches == null || (patches != null && patches.isEmpty())) {
            ...
            throw new ExperienceException(SessionErrorCode.SESSION_ATTRIBUTE_UNEXPECTED, new Object[]{ "patch", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        ...
        try {
            ...
            if(e.getMessage().contains("no such path in target")) {
                ...
                ex = new ExperienceException(SessionErrorCode.SESSION_ATTRIBUTE_INVALID, new Object[]{ "path" });
            } else {
                ex = new ExperienceException(SessionErrorCode.SESSION_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
            }
            throw ex;
        } catch (IOException e) {
            log.debug("Failed to patch list items to ExperienceDto: {}", e);
            throw new ExperienceException(SessionErrorCode.SESSION_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
        }
