package com.teenthofabud.restaurant.solution.session.association.service.impl;
...
import com.teenthofabud.restaurant.solution.session.association.converter.AssociationDto2DocumentConverter;
import com.teenthofabud.restaurant.solution.session.association.converter.AssociationForm2DocumentConverter;
...
import com.teenthofabud.restaurant.solution.session.association.data.AssociationMessageTemplate;
import com.teenthofabud.restaurant.solution.session.association.data.AssociationVo;
import com.teenthofabud.restaurant.solution.session.association.mapper.AssociationDocumentSelfMapper;
import com.teenthofabud.restaurant.solution.session.association.mapper.AssociationForm2DocumentMapper;
import com.teenthofabud.restaurant.solution.session.association.repository.AssociationRepository;
import com.teenthofabud.restaurant.solution.session.association.service.AssociationService;
import com.teenthofabud.restaurant.solution.session.association.validator.AssociationDtoValidator;
import com.teenthofabud.restaurant.solution.session.association.validator.AssociationFormRelaxedValidator;
import com.teenthofabud.restaurant.solution.session.association.validator.AssociationFormValidator;
...
public class AssociationServiceImpl implements AssociationService {
    ...
    private Long parseAssociationId(String id) throws AssociationException {
        ...
        try {
            ...
            throw new AssociationException(SessionErrorCode.SESSION_ATTRIBUTE_INVALID, new Object[] { "id", id });
        }
    ...
    public Set<AssociationVo> retrieveAllByNaturalOrdering() {
        ...
        List<AssociationVo> associationVoList = sessionServiceHelper.associationDocument2DetailedVo(associationDocumentList);
    ...
    public AssociationVo retrieveDetailsById(String id, Optional<TOABCascadeLevel> optionalCascadeLevel) throws AssociationException {
        ...
        if(optDocument.isEmpty()) {
            ...
            throw new AssociationException(SessionErrorCode.SESSION_NOT_FOUND, new Object[] { "id", String.valueOf(id) });
        }
        ...
        AssociationVo vo = sessionServiceHelper.associationDocument2DetailedVo(document);
    ...
    public List<AssociationVo> retrieveAllMatchingDetailsByExperienceId(String experienceId, Optional<TOABCascadeLevel> optionalCascadeLevel) throws AssociationException {
        ...
        try {
            ...
            if(!experienceVo.getActive()) {
                throw new ExperienceException(SessionErrorCode.SESSION_INACTIVE, new Object [] { experienceId });
            }
        } catch (ExperienceException e) {
            log.error("experienceId is invalid", e);
            throw new AssociationException(SessionErrorCode.SESSION_ATTRIBUTE_INVALID, new Object [] { "experienceId: " + experienceId });
        }
        List<AssociationDocument> associationDocumentList = repository.findByExperienceId(experienceId);
        TOABCascadeLevel cascadeLevel = optionalCascadeLevel.isPresent() ? optionalCascadeLevel.get() : TOABCascadeLevel.ZERO;
        TOABRequestContextHolder.setCascadeLevelContext(cascadeLevel);
        List<AssociationVo> matchedAssociationList = sessionServiceHelper.associationDocument2DetailedVo(associationDocumentList);
        ...
        if(matchedAssociationList.isEmpty()) {
            ...
            throw new AssociationException(SessionErrorCode.SESSION_NOT_FOUND, new Object[] { "experienceId", experienceId });
        }
    ...
    public List<AssociationVo> retrieveAllMatchingDetailsByCriteria(Optional<String> optionalTableId, Optional<String> optionalAccountId) throws AssociationException {
        ...
        matchedAssociationList = sessionServiceHelper.associationDocument2DetailedVo(associationDocumentList);
    ...
    public String createAssociation(AssociationForm form) throws AssociationException {
        ...
        if(form == null) {
            ...
            throw new AssociationException(SessionErrorCode.SESSION_ATTRIBUTE_UNEXPECTED,
        ...
        if(repository.existsByTableIdAndAccountId(expectedDocument.getTableId(), expectedDocument.getAccountId())) {
            ...
            throw new AssociationException(SessionErrorCode.SESSION_EXISTS,
        ...
        if(actualDocument == null) {
            ...
            throw new AssociationException(SessionErrorCode.SESSION_ACTION_FAILURE,
    ...
    public void updateAssociation(String id, AssociationForm form) throws AssociationException {
        ...
        if(!actualDocument.getActive()) {
            ...
            throw new AssociationException(SessionErrorCode.SESSION_INACTIVE, new Object[] { String.valueOf(id) });
        }
        log.debug("AssociationDocument is active with id: {}", id);

        if(form == null) {
            log.debug("AssociationForm is null");
            throw new AssociationException(SessionErrorCode.SESSION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        log.debug("Form details : {}", form);
        ...
        if(err.hasErrors()) {
            ...
            throw new AssociationException(SessionErrorCode.SESSION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are empty" });
        }
        log.debug("All attributes of AssociationForm are valid");
        ...
        if(optExpectedDocument.isEmpty()) {
            ...
            throw new AssociationException(SessionErrorCode.SESSION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are expected with new values" });
        }
    ...
    public void applyPatchOnAssociation(String id, List<PatchOperationForm> patches) throws AssociationException {
        ...
        if(patches == null || (patches != null && patches.isEmpty())) {
            ...
            throw new AssociationException(SessionErrorCode.SESSION_ATTRIBUTE_UNEXPECTED, new Object[]{ "patch", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        ...
        try {
            ...
            if(e.getMessage().contains("no such path in target")) {
                ...
                ex = new AssociationException(SessionErrorCode.SESSION_ATTRIBUTE_INVALID, new Object[]{ "path" });
            } else {
                ex = new AssociationException(SessionErrorCode.SESSION_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
            }
            throw ex;
        } catch (IOException e) {
            log.debug("Failed to patch list items to AssociationDto: {}", e);
            throw new AssociationException(SessionErrorCode.SESSION_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
        }
    ...
    private void checkUniquenessOfAssociation(AssociationDto patchedAssociationForm, AssociationDocument actualDocument) throws AssociationException {
        ...
        if(!similaritySwitchesCollection.isEmpty()) {
            ...
            if(sameDocumentSw || duplicateDocumentSw) {
                ...
                throw new AssociationException(SessionErrorCode.SESSION_EXISTS, new Object[]{ "tableId: " + tableId, ", accountId: " + accountId });
            }
