package com.teenthofabud.restaurant.solution.session.experience.controller;
...
import com.teenthofabud.restaurant.solution.session.experience.data.ExperienceMessageTemplate;
...
public class ExperienceController {
    ...
    public List<ExperienceVo> getAllExperiencesByFilters(@RequestParam(required = false) String name,
        ...
        throw new ExperienceException(SessionErrorCode.SESSION_ATTRIBUTE_INVALID, new Object[] { "filters" });
    }
    ...
    @io.swagger.v3.oas.annotations.Parameter(in = ParameterIn.QUERY, description = "levels of nested fields to be unfolded within the response body")
        ...
        if(StringUtils.hasText(StringUtils.trimWhitespace(id)) && StringUtils.isEmpty(StringUtils.trimWhitespace(cascadeUntilLevel))) {
            ...
            try {
                ...
                throw new ExperienceException(SessionErrorCode.SESSION_ATTRIBUTE_INVALID, new Object[] { "cascadeUntilLevel", cascadeUntilLevel });
            }
        }
        log.debug(ExperienceMessageTemplate.MSG_TEMPLATE_EXPERIENCE_ID_EMPTY.getValue());
        throw new ExperienceException(SessionErrorCode.SESSION_ATTRIBUTE_INVALID, new Object[] { "id", id });
