...
public class EngagementServiceImpl implements EngagementService {
    ...
    public EngagementVo retrieveDetailsById(String id, Optional<TOABCascadeLevel> optionalCascadeLevel) throws EngagementException {
        ...
        if(optDocument.isEmpty()) {
            ...
            throw new EngagementException(ReservationErrorCode.BOOKING_NOT_FOUND, new Object[] { "id", String.valueOf(id) });
        }
    ...
    public List<EngagementVo> retrieveAllMatchingDetailsByAssociationId(String associationId, Optional<TOABCascadeLevel> optionalCascadeLevel) throws EngagementException {
        ...
        try {
            ...
            if(!bookingVo.getActive()) {
                throw new BookingException(ReservationErrorCode.BOOKING_INACTIVE, new Object [] { associationId });
            }
        ...
        if(matchedEngagementList.isEmpty()) {
            ...
            throw new EngagementException(ReservationErrorCode.BOOKING_NOT_FOUND, new Object[] { "associationId", associationId });
        }
    ...
    public List<EngagementVo> retrieveAllMatchingDetailsByCriteria(Optional<String> optionalAssociationId, Optional<String> optionalEvent, Optional<String> optionalTimestamp) throws EngagementException {
        ...
        if(StringUtils.hasText(StringUtils.trimWhitespace(timestamp))) {
            try {
                ...
                throw new EngagementException(ReservationErrorCode.BOOKING_ATTRIBUTE_INVALID, new Object[] { "timestamp", timestamp });
            } 
            log.debug("event {} is valid", event);
            providedFilters.put("event", event);
            document.setEvent(EngagementEvent.valueOf(event));
    ...
    public String createEngagement(EngagementForm form) throws EngagementException {
        ...
        if(repository.existsByAssociationIdAndEventAndDateAndTime(
            ...
            log.debug(EngagementMessageTemplate.MSG_TEMPLATE_ENGAGEMENT_EXISTS_BY_ASSOCIATION_ID_EVENT_DATE_TIME.getValue(),
                    expectedDocument.getAssociationId(), expectedDocument.getEvent(), expectedDocument.getDate(), expectedDocument.getTime());
            throw new EngagementException(ReservationErrorCode.BOOKING_EXISTS,
        ...
        if(actualDocument == null) {
            ...
            throw new EngagementException(ReservationErrorCode.BOOKING_ACTION_FAILURE,
    ...
    public void updateEngagement(String id, EngagementForm form) throws EngagementException {
        ...
        if(!actualDocument.getActive()) {
            ...
            throw new EngagementException(ReservationErrorCode.BOOKING_INACTIVE, new Object[] { String.valueOf(id) });
        }
        log.debug("EngagementDocument is active with id: {}", id);

        if(form == null) {
            log.debug("EngagementForm is null");
            throw new EngagementException(ReservationErrorCode.BOOKING_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        log.debug("Form details : {}", form);
        ...
        if(err.hasErrors()) {
            ...
            throw new EngagementException(ReservationErrorCode.BOOKING_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are empty" });
        }
        log.debug("All attributes of EngagementForm are valid");
        ...
        if(optExpectedDocument.isEmpty()) {
            ...
            throw new EngagementException(ReservationErrorCode.BOOKING_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are expected with new values" });
        }
    ...
    public void applyPatchOnEngagement(String id, List<PatchOperationForm> patches) throws EngagementException {
        ...
        if(patches == null || (patches != null && patches.isEmpty())) {
            ...
            throw new EngagementException(ReservationErrorCode.BOOKING_ATTRIBUTE_UNEXPECTED, new Object[]{ "patch", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        ...
        try {
            toabBaseService.validatePatches(patches, ReservationErrorCode.BOOKING_EXISTS.getDomain() + ":LOV");
        ...
        try {
            ...
            if(e.getMessage().contains("no such path in target")) {
                ...
                ex = new EngagementException(ReservationErrorCode.BOOKING_ATTRIBUTE_INVALID, new Object[]{ "path" });
            } else {
                ex = new EngagementException(ReservationErrorCode.BOOKING_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
            }
            throw ex;
        } catch (IOException e) {
            log.debug("Failed to patch list items to EngagementDto: {}", e);
            throw new EngagementException(ReservationErrorCode.BOOKING_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
        }
