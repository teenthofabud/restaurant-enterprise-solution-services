package com.teenthofabud.restaurant.solution.reservation.integration.customer.error;
...
@Slf4j
@Component
public class CustomerServiceClientExceptionHandler extends TOABFeignBaseExceptionHandler {
