package com.teenthofabud.restaurant.solution.reservation.integration.establishmentarea.proxy;

import com.teenthofabud.core.common.data.vo.HealthVo;
import com.teenthofabud.core.common.marker.TOABFeignErrorHandler;
import com.teenthofabud.restaurant.solution.reservation.integration.establishmentarea.configuration.EstablishmentAreaServiceIntegrationConfiguration;
import com.teenthofabud.restaurant.solution.reservation.integration.establishmentarea.data.TableVo;
import com.teenthofabud.restaurant.solution.reservation.integration.establishmentarea.error.EstablishmentAreaServiceClientExceptionHandler;
...
@FeignClient(value = EstablishmentAreaServiceClient.SERVICE_CLIENT_NAME, url = "${booking.establishmentarea.service.url}", configuration = EstablishmentAreaServiceIntegrationConfiguration.class)
