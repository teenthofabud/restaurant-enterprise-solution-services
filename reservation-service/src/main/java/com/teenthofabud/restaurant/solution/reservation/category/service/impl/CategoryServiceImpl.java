package com.teenthofabud.restaurant.solution.reservation.category.service.impl;
...
import com.teenthofabud.restaurant.solution.reservation.category.converter.CategoryDto2DocumentConverter;
import com.teenthofabud.restaurant.solution.reservation.category.converter.CategoryForm2DocumentConverter;
import com.teenthofabud.restaurant.solution.reservation.category.data.*;
import com.teenthofabud.restaurant.solution.reservation.category.mapper.CategoryDocumentSelfMapper;
import com.teenthofabud.restaurant.solution.reservation.category.mapper.CategoryForm2DocumentMapper;
...
import com.teenthofabud.restaurant.solution.reservation.category.validator.CategoryDtoValidator;
import com.teenthofabud.restaurant.solution.reservation.category.validator.CategoryFormRelaxedValidator;
import com.teenthofabud.restaurant.solution.reservation.category.validator.CategoryFormValidator;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    private Long parseCategoryId(String id) throws CategoryException {
        ...
        try {
            ...
            throw new CategoryException(ReservationErrorCode.RESERVATION_ATTRIBUTE_INVALID, new Object[] { "id", id });
        }
        return categoryId;
    }
    ...
    public Set<CategoryVo> retrieveAllByNaturalOrdering() {
        ...
        List<CategoryVo> categoryVoList = reservationServiceHelper.categoryDocument2DetailedVo(categoryDocumentList);
    ...
    public CategoryVo retrieveDetailsById(String id, Optional<TOABCascadeLevel> optionalCascadeLevel) throws CategoryException {
        ...
        if(optDocument.isEmpty()) {
            ...
            throw new CategoryException(ReservationErrorCode.RESERVATION_NOT_FOUND, new Object[] { "id", String.valueOf(id) });
        }
        ...
        CategoryVo vo = reservationServiceHelper.categoryDocument2DetailedVo(document);
    ...
    public List<CategoryVo> retrieveAllMatchingDetailsByCriteria(
        ...
        matchedCategoryList = reservationServiceHelper.categoryDocument2DetailedVo(categoryDocumentList);
    ...
    public String createCategory(CategoryForm form) throws CategoryException {
        ...
        if(form == null) {
            ...
            throw new CategoryException(ReservationErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED,
        ...
        if(repository.existsByName(expectedDocument.getName())) {
            ...
            throw new CategoryException(ReservationErrorCode.RESERVATION_EXISTS,
        ...
        if(actualDocument == null) {
            ...
            throw new CategoryException(ReservationErrorCode.RESERVATION_ACTION_FAILURE,
    ...
    public void updateCategory(String id, CategoryForm form) throws CategoryException {
        ...
        if(!actualDocument.getActive()) {
            ...
            throw new CategoryException(ReservationErrorCode.RESERVATION_INACTIVE, new Object[] { String.valueOf(id) });
        }
        log.debug("CategoryDocument is active with id: {}", id);

        if(form == null) {
            log.debug("CategoryForm is null");
            throw new CategoryException(ReservationErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        log.debug("Form details : {}", form);
        ...
        if(err.hasErrors()) {
            ...
            throw new CategoryException(ReservationErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are empty" });
        }
        log.debug("All attributes of CategoryForm are valid");
        ...
        if(optExpectedDocument.isEmpty()) {
            ...
            throw new CategoryException(ReservationErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are expected with new values" });
        }
    ...
    public void applyPatchOnCategory(String id, List<PatchOperationForm> patches) throws CategoryException {
        ...
        if(patches == null || (patches != null && patches.isEmpty())) {
            ...
            throw new CategoryException(ReservationErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED, new Object[]{ "patch", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        ...
        try {
            ...
            if(e.getMessage().contains("no such path in target")) {
                ...
                ex = new CategoryException(ReservationErrorCode.RESERVATION_ATTRIBUTE_INVALID, new Object[]{ "path" });
            } else {
                ex = new CategoryException(ReservationErrorCode.RESERVATION_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
            }
            throw ex;
        } catch (IOException e) {
            log.debug("Failed to patch list items to CategoryDto: {}", e);
            throw new CategoryException(ReservationErrorCode.RESERVATION_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
        }
