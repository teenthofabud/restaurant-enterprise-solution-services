package com.teenthofabud.restaurant.solution.reservation.integration.customer.proxy;

import com.teenthofabud.core.common.data.vo.HealthVo;
import com.teenthofabud.core.common.marker.TOABFeignErrorHandler;
import com.teenthofabud.restaurant.solution.reservation.integration.customer.configuration.CustomerServiceIntegrationConfiguration;
import com.teenthofabud.restaurant.solution.reservation.integration.customer.data.AccountVo;
import com.teenthofabud.restaurant.solution.reservation.integration.customer.error.CustomerServiceClientExceptionHandler;
...
@FeignClient(value = CustomerServiceClient.SERVICE_CLIENT_NAME, url = "${reservation.customer.service.url}", configuration = CustomerServiceIntegrationConfiguration.class)
