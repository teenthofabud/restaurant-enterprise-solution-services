...
@FeignClient(value = CustomerServiceClient.SERVICE_CLIENT_NAME, url = "${booking.customer.service.url}", configuration = CustomerServiceIntegrationConfiguration.class)
