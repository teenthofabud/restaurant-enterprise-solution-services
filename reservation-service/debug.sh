...
-jar \
-DRESERVATION_SPRING_PROFILES_ACTIVE=development \
-DRESERVATION_EUREKA_CLIENT_ENABLED=true \
-DRESERVATION_SPRING_CLOUD_CONFIG_ENABLED=true \
...
-DRESERVATION_METADATA_GENDER_FEIGN_LOGGING_LEVEL=full \
