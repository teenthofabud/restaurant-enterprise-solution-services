...
@FeignClient(value = InventoryServiceClient.SERVICE_CLIENT_NAME, url = "${cookbook.inventory.service.host}", configuration = InventoryServiceIntegrationConfiguration.class)
