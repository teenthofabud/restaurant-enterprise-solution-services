package com.teenthofabud.restaurant.solution.cookbook.integration.inventory.product.validator;
...
public class ProductIdValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        productVo = productServiceClient.getProductDetailsById(productId);
