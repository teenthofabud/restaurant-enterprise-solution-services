package com.teenthofabud.restaurant.solution.cookbook.integration.inventory.error;
...
@Slf4j
@Component
public class InventoryServiceClientExceptionHandler extends TOABFeignBaseExceptionHandler {
