package com.teenthofabud.restaurant.solution.engagement.engagement.service.impl;
...
import com.teenthofabud.restaurant.solution.engagement.engagement.converter.EngagementDto2DocumentConverter;
import com.teenthofabud.restaurant.solution.engagement.engagement.converter.EngagementForm2DocumentConverter;
import com.teenthofabud.restaurant.solution.checkin.engagement.data.*;
import com.teenthofabud.restaurant.solution.engagement.engagement.mapper.EngagementDocumentSelfMapper;
import com.teenthofabud.restaurant.solution.engagement.engagement.mapper.EngagementForm2DocumentMapper;
...
import com.teenthofabud.restaurant.solution.engagement.engagement.service.EngagementService;
import com.teenthofabud.restaurant.solution.engagement.engagement.validator.EngagementDtoValidator;
import com.teenthofabud.restaurant.solution.engagement.engagement.validator.EngagementFormRelaxedValidator;
import com.teenthofabud.restaurant.solution.engagement.engagement.validator.EngagementFormValidator;
...
import com.teenthofabud.restaurant.solution.engagement.engagement.data.*;
...
public class EngagementServiceImpl implements EngagementService {
    ...
    @Autowired
    public void setReservationServiceHelper(CheckInServiceHelper checkInServiceHelper) {
        this.checkInServiceHelper = checkInServiceHelper;
    }
    ...
    private Long parseEngagementId(String id) throws EngagementException {
        ...
        try {
            ...
            throw new EngagementException(CheckInErrorCode.RESERVATION_ATTRIBUTE_INVALID, new Object[] { "id", id });
        }
        return engagementId;
    }
    ...
    public Set<EngagementVo> retrieveAllByNaturalOrdering() {
        ...
        List<EngagementVo> engagementVoList = checkInServiceHelper.engagementDocument2DetailedVo(engagementDocumentList);
    ...
    public EngagementVo retrieveDetailsById(String id, Optional<TOABCascadeLevel> optionalCascadeLevel) throws EngagementException {
        ...
        if(optionalDineInEngagementDocument.isEmpty() && optionalTakeAwayEngagementDocument.isEmpty() && optionalDeliveryEngagementDocument.isEmpty()) {
            ...
            throw new EngagementException(CheckInErrorCode.RESERVATION_NOT_FOUND, new Object[] { "id", String.valueOf(id) });
        }
        ...
        EngagementVo vo = checkInServiceHelper.engagementDocument2DetailedVo(engagementDocument);
    ...
    public List<EngagementVo> retrieveAllMatchingDetailsByBookingId(String bookingId, Optional<TOABCascadeLevel> optionalCascadeLevel) throws EngagementException {
        ...
        try {
            ...
            if(!bookingVo.getActive()) {
                throw new BookingException(CheckInErrorCode.RESERVATION_INACTIVE, new Object [] { bookingId });
            }
        } catch (BookingException e) {
            log.error("bookingId is invalid", e);
            throw new EngagementException(CheckInErrorCode.RESERVATION_ATTRIBUTE_INVALID, new Object [] { "bookingId: " + bookingId });
        }
        ...
        if(dineInEngagementDocumentList.isEmpty() && deliveryEngagementDocumentList.isEmpty() && takeAwayEngagementDocumentList.isEmpty()) {
            ...
            throw new EngagementException(CheckInErrorCode.RESERVATION_NOT_FOUND, new Object[] { "bookingId", String.valueOf(bookingId) });
        }
        if(!dineInEngagementDocumentList.isEmpty() && !deliveryEngagementDocumentList.isEmpty() && !takeAwayEngagementDocumentList.isEmpty()) {
            log.debug("Multiple EngagementDocument found by bookingId: {}", bookingId);
            throw new EngagementException(CheckInErrorCode.RESERVATION_ACTION_FAILURE, new Object[] { "get by bookingId", "multiple matches  by type" });
        }
        ...
        TOABRequestContextHolder.setCascadeLevelContext(cascadeLevel);
        List<EngagementVo> matchedEngagementList = checkInServiceHelper.engagementDocument2DetailedVo(engagementDocumentList);
        ...
        if(matchedEngagementList.isEmpty()) {
            ...
            throw new EngagementException(CheckInErrorCode.RESERVATION_NOT_FOUND, new Object[] { "bookingId", bookingId });
        }
    ...
    public List<EngagementVo> retrieveAllMatchingDetailsByCriteria(Optional<String> optionalBookingId, Optional<String> optionalTokenNumber, Optional<String> optionalTableId, Optional<String> optionalExtRef, Optional<String> optionalInstructions) throws EngagementException {
        ...
        matchedEngagementList = checkInServiceHelper.engagementDocument2DetailedVo(engagementDocumentList);
    ...
    public String createDineInEngagement(EngagementForm form) throws EngagementException {
        ...
        if(form == null) {
            ...
            throw new EngagementException(CheckInErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED,
        ...
        if(dineInEngagementRepository.existsByBookingIdAndTokenNumberAndTableIdAndNoOfPersons(
            ...
            throw new EngagementException(CheckInErrorCode.RESERVATION_EXISTS,
        ...
        if(actualDocument == null) {
            ...
            throw new EngagementException(CheckInErrorCode.RESERVATION_ACTION_FAILURE,
    ...
    public void updateEngagement(String id, EngagementForm form) throws EngagementException {
        ...
        if(!actualDocument.getActive()) {
            ...
            throw new EngagementException(CheckInErrorCode.RESERVATION_INACTIVE, new Object[] { String.valueOf(id) });
        }
        log.debug("EngagementDocument is active with id: {}", id);

        if(form == null) {
            log.debug("EngagementForm is null");
            throw new EngagementException(CheckInErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        log.debug("Form details : {}", form);
        ...
        if(err.hasErrors()) {
            ...
            throw new EngagementException(CheckInErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are empty" });
        }
        log.debug("All attributes of EngagementForm are valid");
        ...
        if(optExpectedDocument.isEmpty()) {
            ...
            throw new EngagementException(CheckInErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are expected with new values" });
        }
    ...
    public void applyPatchOnEngagement(String id, List<PatchOperationForm> patches) throws EngagementException {
        ...
        if(patches == null || (patches != null && patches.isEmpty())) {
            ...
            throw new EngagementException(CheckInErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED, new Object[]{ "patch", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        ...
        try {
            ...
            if(e.getMessage().contains("no such path in target")) {
                ...
                ex = new EngagementException(CheckInErrorCode.RESERVATION_ATTRIBUTE_INVALID, new Object[]{ "path" });
            } else {
                ex = new EngagementException(CheckInErrorCode.RESERVATION_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
            }
            throw ex;
        } catch (IOException e) {
            log.debug("Failed to patch list items to EngagementDto: {}", e);
            throw new EngagementException(CheckInErrorCode.RESERVATION_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
        }
