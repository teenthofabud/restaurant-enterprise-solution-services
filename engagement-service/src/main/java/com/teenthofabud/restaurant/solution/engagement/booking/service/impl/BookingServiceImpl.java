package com.teenthofabud.restaurant.solution.engagement.booking.service.impl;
...
import com.teenthofabud.restaurant.solution.engagement.booking.converter.BookingDto2DocumentConverter;
import com.teenthofabud.restaurant.solution.engagement.booking.converter.BookingForm2DocumentConverter;
...
import com.teenthofabud.restaurant.solution.engagement.booking.data.BookingMessageTemplate;
import com.teenthofabud.restaurant.solution.engagement.booking.data.BookingVo;
import com.teenthofabud.restaurant.solution.engagement.booking.mapper.BookingDocumentSelfMapper;
import com.teenthofabud.restaurant.solution.engagement.booking.mapper.BookingForm2DocumentMapper;
import com.teenthofabud.restaurant.solution.engagement.booking.repository.BookingRepository;
import com.teenthofabud.restaurant.solution.engagement.booking.service.BookingService;
import com.teenthofabud.restaurant.solution.engagement.booking.validator.BookingDtoValidator;
import com.teenthofabud.restaurant.solution.engagement.booking.validator.BookingFormRelaxedValidator;
import com.teenthofabud.restaurant.solution.engagement.booking.validator.BookingFormValidator;
...
public class BookingServiceImpl implements BookingService {
    ...
    private Long parseBookingId(String id) throws BookingException {
        ...
        try {
            ...
            throw new BookingException(CheckInErrorCode.RESERVATION_ATTRIBUTE_INVALID, new Object[] { "id", id });
        }
        return bookingId;
    }
    ...
    public Set<BookingVo> retrieveAllByNaturalOrdering() {
        ...
        List<BookingVo> bookingVoList = checkInServiceHelper.bookingDocument2DetailedVo(bookingDocumentList);
    ...
    public BookingVo retrieveDetailsById(String id, Optional<TOABCascadeLevel> optionalCascadeLevel) throws BookingException {
        ...
        if(optDocument.isEmpty()) {
            ...
            throw new BookingException(CheckInErrorCode.RESERVATION_NOT_FOUND, new Object[] { "id", String.valueOf(id) });
        }
        ...
        BookingVo vo = checkInServiceHelper.bookingDocument2DetailedVo(document);
    ...
    public List<BookingVo> retrieveAllMatchingDetailsByCategoryId(String categoryId, Optional<TOABCascadeLevel> optionalCascadeLevel) throws BookingException {
        ...
        try {
            ...
            if(!categoryVo.getActive()) {
                throw new CategoryException(CheckInErrorCode.RESERVATION_INACTIVE, new Object [] { categoryId });
            }
        } catch (CategoryException e) {
            log.error("categoryId is invalid", e);
            throw new BookingException(CheckInErrorCode.RESERVATION_ATTRIBUTE_INVALID, new Object [] { "categoryId: " + categoryId });
        }
        List<BookingDocument> bookingDocumentList = repository.findByCategoryId(categoryId);
        TOABCascadeLevel cascadeLevel = optionalCascadeLevel.isPresent() ? optionalCascadeLevel.get() : TOABCascadeLevel.ZERO;
        TOABRequestContextHolder.setCascadeLevelContext(cascadeLevel);
        List<BookingVo> matchedBookingList = checkInServiceHelper.bookingDocument2DetailedVo(bookingDocumentList);
        ...
        if(matchedBookingList.isEmpty()) {
            ...
            throw new BookingException(CheckInErrorCode.RESERVATION_NOT_FOUND, new Object[] { "categoryId", categoryId });
        }
    ...
    public List<BookingVo> retrieveAllMatchingDetailsByCriteria(Optional<String> optionalTimestamp, Optional<String> optionalAccountId) throws BookingException {
        ...
        matchedBookingList = checkInServiceHelper.bookingDocument2DetailedVo(bookingDocumentList);
    ...
    public List<BookingVo> retrieveAllMatchingDetailsByCriteria(Optional<String> optionalTimestamp, Optional<String> optionalAccountId, Optional<String> optionalCategoryId) throws BookingException {
        ...
        if(StringUtils.hasText(StringUtils.trimWhitespace(timestamp))) {
            ...
            try {
                ...
                throw new BookingException(CheckInErrorCode.RESERVATION_ATTRIBUTE_INVALID, new Object[] { "timestamp", timestamp });
            }
            log.debug("timestamp {} is valid", timestamp);
            providedFilters.put("timestamp", timestamp);
    ...
    public String createBooking(BookingForm form) throws BookingException {
        ...
        if(form == null) {
            ...
            throw new BookingException(CheckInErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED,
        ...
        if(repository.existsByAccountIdAndTimestampAndCategoryId(expectedDocument.getAccountId(), expectedDocument.getTimestamp(), expectedDocument.getCategoryId())) {
            ...
            throw new BookingException(CheckInErrorCode.RESERVATION_EXISTS,
        ...
        if(actualDocument == null) {
            ...
            throw new BookingException(CheckInErrorCode.RESERVATION_ACTION_FAILURE,
    ...
    public void updateBooking(String id, BookingForm form) throws BookingException {
        ...
        if(!actualDocument.getActive()) {
            ...
            throw new BookingException(CheckInErrorCode.RESERVATION_INACTIVE, new Object[] { String.valueOf(id) });
        }
        log.debug("BookingDocument is active with id: {}", id);

        if(form == null) {
            log.debug("BookingForm is null");
            throw new BookingException(CheckInErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        log.debug("Form details : {}", form);
        ...
        if(err.hasErrors()) {
            ...
            throw new BookingException(CheckInErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are empty" });
        }
        log.debug("All attributes of BookingForm are valid");
        ...
        if(optExpectedDocument.isEmpty()) {
            ...
            throw new BookingException(CheckInErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED, new Object[]{ "form", "fields are expected with new values" });
        }
    ...
    public void applyPatchOnBooking(String id, List<PatchOperationForm> patches) throws BookingException {
        ...
        if(patches == null || (patches != null && patches.isEmpty())) {
            ...
            throw new BookingException(CheckInErrorCode.RESERVATION_ATTRIBUTE_UNEXPECTED, new Object[]{ "patch", TOABBaseMessageTemplate.MSG_TEMPLATE_NOT_PROVIDED });
        }
        ...
        try {
            ...
            if(e.getMessage().contains("no such path in target")) {
                ...
                ex = new BookingException(CheckInErrorCode.RESERVATION_ATTRIBUTE_INVALID, new Object[]{ "path" });
            } else {
                ex = new BookingException(CheckInErrorCode.RESERVATION_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
            }
            throw ex;
        } catch (IOException e) {
            log.debug("Failed to patch list items to BookingDto: {}", e);
            throw new BookingException(CheckInErrorCode.RESERVATION_ACTION_FAILURE, new Object[]{ "patching", "internal error: " + e.getMessage() });
        }
        ...
        if(!similaritySwitchesCollection.isEmpty()) {
           ...
           /* String timestamp = patchedBookingForm.getTimestamp().isPresent() ? patchedBookingForm.getTimestamp().get()
            ...
            if(sameDocumentSw || duplicateDocumentSw) {
                ...
                throw new BookingException(CheckInErrorCode.RESERVATION_EXISTS, new Object[]{ "accountId: " + accountId,
