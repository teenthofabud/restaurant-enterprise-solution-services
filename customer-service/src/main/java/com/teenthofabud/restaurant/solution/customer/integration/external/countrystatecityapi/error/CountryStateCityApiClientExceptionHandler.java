...
public class CountryStateCityApiClientExceptionHandler extends TOABFeignBaseExceptionHandler {
    ...
    public Optional<ErrorVo> getClientErrorMappedNativeErrorModel(byte[] bytes) {
        ...
        try {
            com.teenthofabud.restaurant.solution.customer.integration.external.countrystatecityapi.data.ErrorVo errorDetails
                    = super.getObjectMapper().readValue(bytes,
                    com.teenthofabud.restaurant.solution.customer.integration.external.countrystatecityapi.data.ErrorVo.class);
